      ...
      <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 border-b border-white/7 bg-[#050505]/90 backdrop-blur-md relative">
        <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity group">
          ...
          <div className="font-serif text-xl tracking-widest text-[#D4AF37]">
            Marquee <span className="text-white/30 text-xs tracking-[0.3em] font-sans ml-2">CAMPUSES</span>
          </div>
        </Link>
        <Link
          to="/"
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-24 flex flex-col items-center text-center">
        ...
        >
          <div className="w-24 h-24 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20 flex items-center justify-center">
            <BookOpen size={40} className="text-[#D4AF37]" strokeWidth={1.5} />
          </div>
        </motion.div>
        ...
        >
          Your institution hasn't scheduled any placement assessments at this time.
          Check back later or contact your placement coordinator for upcoming mock interviews and evaluation cycles.
        </motion.p>
        ...
        >
          <div className="border border-white/10 bg-white/[0.02] p-6 text-left">
            <Users size={24} className="text-[#D4AF37] mb-3" strokeWidth={1.5} />
            <h3 className="font-serif text-xl text-white mb-2">Campus Access</h3>
            <p className="text-white/50 text-sm leading-relaxed">
              Your campus admin will assign cohort-based mock interviews and track readiness scores.
            </p>
          </div>

          <div className="border border-white/10 bg-white/[0.02] p-6 text-left">
            <Calendar size={24} className="text-[#D4AF37] mb-3" strokeWidth={1.5} />
            <h3 className="font-serif text-xl text-white mb-2">Scheduled Cycles</h3>
            <p className="text-white/50 text-sm leading-relaxed">
              When assessments are scheduled, they'll appear here with dates and instructions.
            </p>
          </div>

          <div className="border border-white/10 bg-white/[0.02] p-6 text-left">
            <BookOpen size={24} className="text-[#D4AF37] mb-3" strokeWidth={1.5} />
            <h3 className="font-serif text-xl text-white mb-2">Practice Mode</h3>
            <p className="text-white/50 text-sm leading-relaxed">
              While you wait, use self-practice mode to prepare on your own schedule.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <a
            href="mailto:placement@yourcampus.edu"
